...
'''references: https://blog.csdn.net/pixian3729/article/details/110261140'''
...
if __name__=='__main__':
    ...
    adj=torch.randn(32,5,5)
    print(adj.shape)
    w=torch.randn(32*12,32*12)
    x=x.permute(0,2,1,3)
    x=torch.reshape(x,(32,5,-1))# 32 5 384

    net=GAT(384,384,64,0.3,0.2,4)
    out=net(x,adj)
